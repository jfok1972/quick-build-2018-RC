...
public class ChineseConvertPinYin {
	...
	public static String getFirstSpellLowerCase(String str) {
		if (StringUtils.isBlank(str))
			return str;
		try {
			return getFirstSpell(str).toLowerCase();
	...
	public void main() throws UnsupportedEncodingException {
		String str = "中华人明共和国   蒋锋";
		// 转换成拼音
		System.out.println(getFullSpell(str));
		// 中文第一个字全拼,其余去首字母
		System.out.println(getFirstSpell(str));
		// ascii 转 字母
		System.out.println(getSpellByAscii(65));
		// 字母 转 ascii
		System.out.println(getCnAscii('0'));
	}
}