Ext.define('app.view.platform.datamining.groupdefine.SelectGroupFieldForm', {
  extend : 'Ext.form.Panel',
  alias : 'widget.datamininggroupdefineform',
  requires : ['expand.ux.field.ModuleFieldPicker'],
  reference : 'groupfieldform',
